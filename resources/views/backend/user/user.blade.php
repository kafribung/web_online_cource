    ...
    <div>
        <div class="shadow overflow-hidden border border-gray-200 sm:rounded-lg m-6">
            <div class="bg-gray-50 flex justify-end p-2">
                <a href="{{ route('user.create') }}" class="border-2 border-blue-200  rounded-md">
                    ...
                    <tr>
                        ...
                        <td id="app" class="px-2 py-4 whitespace-nowrap text-sm text-gray-500">
                            <div class="flex justify-start space-x-1">
                                <a href="{{ route('user.edit', $user->email) }}" class="border-2 border-yellow-200 rounded-md p-1">
                                ...
                                <button   onclick=" deleteuser({{ json_encode($user->email) }})"  class="border-2 border-red-200 rounded-md p-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                {{-- <button  v-on:click.prevent="deleteuser()" class="py-2 px-4 bg-blue-400">Ok</button> --}}
                            </div>
                        </td>
                    </tr>
                    @endforeach
