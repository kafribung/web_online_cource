                    ...
                    <tr>
                        ...
                        <td id="app" class="px-2 py-4 whitespace-nowrap text-sm text-gray-500">
                            <div class="flex justify-start space-x-1">
                                ...
                                <button   onclick=" deleteAdmin({{ json_encode($admin->email) }})"  class="border-2 border-red-200 rounded-md p-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                {{-- <button  v-on:click.prevent="deleteAdmin()" class="py-2 px-4 bg-blue-400">Ok</button> --}}
                            </div>
                        </td>
                    </tr>
                    @endforeach
