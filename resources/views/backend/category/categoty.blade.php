    ...
    <div>
        <div class="shadow overflow-hidden border border-gray-200 sm:rounded-lg m-6">
            <div class="bg-gray-50 flex justify-end p-2">
                <a href="{{ route('category.create') }}" class="border-2 border-blue-200  rounded-md">
            ...
            <table class="w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white text-xs divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td id="app" class="px-2 py-4 whitespace-nowrap text-sm text-gray-500">
                            <div class="flex justify-start space-x-1">
                                <a href="{{ route('category.edit', $category->slug) }}" class="border-2 border-yellow-200 rounded-md p-1">
                                ...
                                <button id="delete" onclick=" deletecategory({{ json_encode($category->slug) }})"  class="border-2 border-red-200 rounded-md p-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    ...
                    @empty
                    <tr>
                        <td colspan="12" class="text-blue-500 text-base text-center">Data is null</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
